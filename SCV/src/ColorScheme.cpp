...
void ColorScheme::loadScheme(ColorScheme::SchemeStyle style) {
   switch (style) {
   case SCVDEFAULT:
      _pColors[CURSOR]          = Color4f(ColorRGBA(255, 255,   0, 255));
      _pColors[TEXT]            = Color4f(ColorRGBA(255, 255, 255, 255));
      ...
      _pColors[CONTEXTMENU]     = Color4f(ColorRGBA(255, 255, 255, 255));
      _pColors[CONTEXTMENUFONT] = Color4f(ColorRGBA(  0,   0,   0, 255));
      _pColors[PANEL]           = Color4f(ColorRGBA( 49, 100, 155, 100));
      _pColors[SCROLLPANEL]     = Color4f(ColorRGBA(200, 200, 200, 255));
      _pColors[MAINCOMPONENTS]  = Color4f(ColorRGBA( 51,  97, 136, 255));
      _pColors[OVERCOMPONENTS]  = Color4f(ColorRGBA(  0, 220, 255, 70));
      _pColors[HOLDCOMPONENTS]  = Color4f(ColorRGBA(116,   0, 163, 255));
      _pColors[FONT]            = Color4f(ColorRGBA(255, 255, 255, 255));
      break;
   case WINDOWS:
      break;
   case OSX:
	   _pColors[CURSOR]          = Color4f(ColorRGBA(  0,   0,   0, 255));
      _pColors[TEXT]            = Color4f(ColorRGBA(  0,   0,   0, 255));
	   ...
	   _pColors[CONTEXTMENU]     = Color4f(ColorRGBA(240, 240, 240, 255));
	   _pColors[CONTEXTMENUFONT] = Color4f(ColorRGBA(  0,   0,   0, 255));
	   _pColors[PANEL]           = Color4f(ColorRGBA( 49, 100, 155, 100));
	   _pColors[SCROLLPANEL]     = Color4f(ColorRGBA( 88, 139, 204, 255));
	   _pColors[MAINCOMPONENTS]  = Color4f(ColorRGBA(210, 210, 210, 255));
	   _pColors[OVERCOMPONENTS]  = Color4f(ColorRGBA(  0, 220, 255, 70));
	   _pColors[HOLDCOMPONENTS]  = Color4f(ColorRGBA(116,   0, 163, 255));
	   _pColors[FONT]            = Color4f(ColorRGBA(  0,   0,   0, 255));
      break;
   case WARCRAFT:
      _pColors[CURSOR]          = Color4f(ColorRGBA(255, 255, 255, 255));
      _pColors[TEXT]            = Color4f(ColorRGBA(255, 255, 255, 255));
      ...
      _pColors[CONTEXTMENU]     = Color4f(ColorRGBA( 63,  94,  53, 255));
      _pColors[CONTEXTMENUFONT] = Color4f(ColorRGBA(219, 157,   0, 255));
      _pColors[PANEL]           = Color4f(ColorRGBA( 63,  94,  53, 100));
      _pColors[SCROLLPANEL]     = Color4f(ColorRGBA(200, 200, 200, 255));
      _pColors[MAINCOMPONENTS]  = Color4f(ColorRGBA(  5, 130,  15, 255));
      _pColors[OVERCOMPONENTS]  = Color4f(ColorRGBA(240, 240, 255, 150));
      _pColors[HOLDCOMPONENTS]  = Color4f(ColorRGBA(116,   0, 163, 255));
      _pColors[FONT]            = Color4f(ColorRGBA(219, 157,   0, 255));
      break;
   case CLEAN:
      _pColors[CURSOR]          = Color4f(ColorRGBA(  0,   0,   0, 255));
      _pColors[TEXT]            = Color4f(ColorRGBA(255, 255, 255, 255));
      ...
      _pColors[CONTEXTMENU]     = Color4f(ColorRGBA(255, 255, 255, 255));
      _pColors[CONTEXTMENUFONT] = Color4f(ColorRGBA(  0,   0,   0, 255));
      _pColors[PANEL]           = Color4f(ColorRGBA( 80,  80,  80, 200));
      _pColors[SCROLLPANEL]     = Color4f(ColorRGBA(200, 200, 200, 255));
      _pColors[MAINCOMPONENTS]  = Color4f(ColorRGBA(151, 197, 236, 255));
      _pColors[OVERCOMPONENTS]  = Color4f(ColorRGBA(  0, 220, 255, 70));
      _pColors[HOLDCOMPONENTS]  = Color4f(ColorRGBA(116,   0, 163, 255));
      _pColors[FONT]            = Color4f(ColorRGBA(  0,   0,   0, 255));
      break;
