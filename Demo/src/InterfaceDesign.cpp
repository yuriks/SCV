...
void InterfaceDesign::onMenuAccessed(const std::deque<std::string> &address) {
   ...
   if (address.size() == 0) {
      ...
      if (address[1] == "Remove Component") {
		  scv::Kernel::getInstance()->removeComponent(m_panel->shared_from_this());
      ...
      if (address[2] == "Button") {
         ...
         if (m_panel == NULL) scv::Kernel::getInstance()->addComponent(scv::Component::Ptr(button));
         else m_panel->addObject(scv::Component::Ptr(button));
         ...
         if (m_panel == NULL) scv::Kernel::getInstance()->addComponent(scv::Component::Ptr(canvas));
         else m_panel->addObject(scv::Component::Ptr(canvas));
         ...
         if (m_panel == NULL) scv::Kernel::getInstance()->addComponent(scv::Component::Ptr(checkbox));
         else panel->addObject(scv::Component::Ptr(checkbox));
         ...
         if (m_panel == NULL) scv::Kernel::getInstance()->addComponent(scv::Component::Ptr(colorpicker));
         else  m_panel->addObject(scv::Component::Ptr(colorpicker));
         ...
         if (m_panel == NULL) scv::Kernel::getInstance()->addComponent(scv::Component::Ptr(combobox));
         else  m_panel->addObject(scv::Component::Ptr(combobox));
      ...
      /**/
         ...
         if (m_panel == NULL) scv::Kernel::getInstance()->addComponent(scv::Component::Ptr(label));
         else panel->addObject(scv::Component::Ptr(label));
         ...
         if (m_panel == NULL) scv::Kernel::getInstance()->addComponent(scv::Component::Ptr(menubar));
         else m_panel->addObject(scv::Component::Ptr(menubar));
         contMenubar++;
         ...
         if (m_panel == NULL) scv::Kernel::getInstance()->addComponent(scv::Component::Ptr(progressbar));
         else panel->addObject(scv::Component::Ptr(progressbar));
         ...
         if (m_panel == NULL) scv::Kernel::getInstance()->addComponent(scv::Component::Ptr(radiobutton));
         else m_panel->addObject(scv::Component::Ptr(radiobutton));
         ...
         if (m_panel == NULL) scv::Kernel::getInstance()->addComponent(scv::Component::Ptr(slider));
         else panel->addObject(scv::Component::Ptr(slider));
         ...
         if (m_panel == NULL) scv::Kernel::getInstance()->addComponent(scv::Component::Ptr(spinner));
         else m_panel->addObject(scv::Component::Ptr(spinner));
         ...
         if (m_panel == NULL) scv::Kernel::getInstance()->addComponent(scv::Component::Ptr(table));
         else m_panel->addObject(scv::Component::Ptr(table));
         ...
         if (m_panel == NULL) scv::Kernel::getInstance()->addComponent(scv::Component::Ptr(textbox));
         else m_panel->addObject(scv::Component::Ptr(textbox));
         ...
         if (m_panel == NULL) scv::Kernel::getInstance()->addComponent(scv::Component::Ptr(textfield));
         else m_panel->addObject(scv::Component::Ptr(textfield));
         ...
         if (m_panel == NULL) scv::Kernel::getInstance()->addComponent(scv::Component::Ptr(togglebutton));
         else m_panel->addObject(scv::Component::Ptr(togglebutton));
         ...
         if (m_panel == NULL) scv::Kernel::getInstance()->addComponent(scv::Component::Ptr(newpanel));
         else m_panel->addObject(scv::Component::Ptr(newpanel));
         ...
         if (m_panel == NULL) scv::Kernel::getInstance()->addComponent(scv::Component::Ptr(newtabbedpane));
         else m_panel->addObject(scv::Component::Ptr(newtabbedpane));
         ...
         if (m_panel == NULL) scv::Kernel::getInstance()->addComponent(scv::Component::Ptr(newscrollpane));
         else m_panel->addObject(scv::Component::Ptr(newscrollpane));
         ...
         if (m_panel == NULL)  scv::Kernel::getInstance()->addComponent(scv::Component::Ptr(tbTV));
         else m_panel->addObject(scv::Component::Ptr(tbTV));
      ...
      if (address[3] == "Horizontal") {
         ...
         if (m_panel == NULL) scv::Kernel::getInstance()->addComponent(scv::Component::Ptr(separator));
         else m_panel->addObject(scv::Component::Ptr(separator));
